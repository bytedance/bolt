...
BENCHMARK_NAMED_PARAM(storeOld, old_fixed_1g, DatasetKind::kFixed, kOneGiB);
BENCHMARK_RELATIVE_NAMED_PARAM(
    storeBm,
    bm_fixed_1g,
    DatasetKind::kFixed,
    kOneGiB);
BENCHMARK_NAMED_PARAM(storeOld, old_fixed_10g, DatasetKind::kFixed, kTenGiB);
BENCHMARK_RELATIVE_NAMED_PARAM(
    storeBm,
    bm_fixed_10g,
    DatasetKind::kFixed,
    kTenGiB);
BENCHMARK_NAMED_PARAM(storeOld, old_variable_1g, DatasetKind::kVariable, kOneGiB);
BENCHMARK_RELATIVE_NAMED_PARAM(
    storeBm,
    bm_variable_1g,
...
BENCHMARK_RELATIVE_NAMED_PARAM(
    ...
    DatasetKind::kVariable,
    kTenGiB);
BENCHMARK_NAMED_PARAM(storeOld, old_fixed_custom, DatasetKind::kFixed, 0);
BENCHMARK_RELATIVE_NAMED_PARAM(storeBm, bm_fixed_custom, DatasetKind::kFixed, 0);
BENCHMARK_NAMED_PARAM(storeOld, old_variable_custom, DatasetKind::kVariable, 0);
BENCHMARK_RELATIVE_NAMED_PARAM(
    storeBm,
    bm_variable_custom,
    DatasetKind::kVariable,
