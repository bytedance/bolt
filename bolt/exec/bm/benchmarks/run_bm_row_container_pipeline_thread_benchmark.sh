...
readonly DEFAULT_BINARY="/data00/home/wangxinshuo.db/bolt/_build/Release/bolt/exec/bm/benchmarks/bolt_exec_bm_row_container_pipeline_thread_benchmark"
readonly DEFAULT_DATA_BYTES="10737418240"
...
output_dir="/data00/home/wangxinshuo.db/bolt/log/bolt-bm-row-container-pipeline-thread-$(date +%Y%m%d-%H%M%S)"
...
usage() {
  cat <<'EOF'
Usage:
  run_bm_row_container_pipeline_thread_benchmark.sh [options] [-- extra benchmark args]

Options:
  --binary PATH              Benchmark binary to run.
                             Default: _build/Release/bolt/exec/bm/benchmarks/bolt_exec_bm_row_container_pipeline_thread_benchmark
